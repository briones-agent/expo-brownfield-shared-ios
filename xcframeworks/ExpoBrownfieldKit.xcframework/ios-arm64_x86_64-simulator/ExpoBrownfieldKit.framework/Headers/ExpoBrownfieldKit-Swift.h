...
#ifndef EXPOBROWNFIELDKIT_SWIFT_H
#define EXPOBROWNFIELDKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpoBrownfieldKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ExpoBrownfieldKit25ExpoBrownfieldAppDelegate")
...
@class UIView;
SWIFT_CLASS("_TtC17ExpoBrownfieldKit22ReactNativeHostManager")
@interface ReactNativeHostManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ReactNativeHostManager * _Nonnull shared;)
+ (ReactNativeHostManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// Initializes ReactNativeHostManager instance
/// Instance can be initialized only once
- (void)initializeWithTurboModuleClasses:(NSDictionary<NSString *, Class> * _Nonnull)turboModuleClasses;
/// Creates the React Native view using RCTReactNativeFactory
- (UIView * _Nullable)loadViewWithModuleName:(NSString * _Nonnull)moduleName initialProps:(NSDictionary * _Nullable)initialProps launchOptions:(NSDictionary * _Nullable)launchOptions error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Initializes a React Native instance
- (void)initializeInstance;
/// Cleans up the previous instance of React Native
/// to prevent memory leaks
- (void)cleanupPreviousInstance;
@end

@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC17ExpoBrownfieldKit25ReactNativeViewController")
